  ...
  def write(self, oprot):
    ...
    if self.success != None:
      ...
      for kiter167,viter168 in self.success.items():
        ...
        oprot.writeListBegin(TType.STRUCT, len(viter168))
...
class batch_mutate_args:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i204 in xrange(_size200):
            ...
            iprot.readMapEnd()
            self.mutation_map[_key205] = _val206
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.mutation_map != None:
      ...
      for kiter220,viter221 in self.mutation_map.items():
        oprot.writeString(kiter220)
        oprot.writeMapBegin(TType.STRING, TType.LIST, len(viter221))
  ...
  def write(self, oprot):
    ...
    if self.success != None:
      ...
      for kiter238,viter239 in self.success.items():
        ...
        oprot.writeListBegin(TType.STRING, len(viter239))
